      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-white to-purple-50 relative overflow-hidden">
          ...
          <div className="mt-40 flex justify-center">
            ...
            <div className="p-10 rounded-xl max-w-screen text-center">
              ...
              <a href="#_" className="mt-10 relative inline-flex items-center justify-center p-4 px-12 py-4 overflow-hidden font-medium text-white transition duration-300 ease-out border-2 border-indigo-400 rounded-xl shadow-md group">
